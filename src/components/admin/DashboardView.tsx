...
/**
 * The organization dashboard body, shared by the organization admin's
 * `/admin` page and the platform owner's organization-context view.
 * The only differences between the two are the link targets and
 * whether the "Create Shipment" button is offered (inspection mode
 * leaves it out).
 */
export function DashboardView({
  ...
  return (
    <div>
      ...
      <div className="mt-8">
        <Link href={shipmentsHref} className="text-sm font-medium text-cargo hover:text-cargo-hover">
